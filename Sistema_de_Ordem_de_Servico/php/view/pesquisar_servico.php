				...
				foreach ($servico as $campo => $valor) {	
					...
					if($campo == 'valor'){
						...
						echo "<div class='coluna col1'>
								<input type='button' class='botao-cadastro' onclick='editarEntidade($idServico)' value='Editar'>
							</div>";

						echo "<div class='coluna col1 sem-padding-right'>
								<input type='button' class='botao-cadastro' onclick='excluirEntidade($idServico)' value='Excluir'>
							</div>";
